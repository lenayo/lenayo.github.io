...
<table width="500"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    <td valign="top" align="center"><img src="images/form/promo-winfeature.jpg" width="500" height="420" border="0"></td>
  </tr>
  ...
  <tr> 
    ...
    Each week, the <b>Riveted by Lee&reg;</b> Web site features one item from our <br>
    10 Easy Pieces collection and we're giving you a chance to win <br>
    our choice! Since we give away a different piece each week,<br>
	you've got plenty of opportunities - just don't forget to register.<br>
	All we need from you is a correct email address<br> 
	so we can notify the lucky winner!<br>
    Read the <a href="#" onclick="openWindow('rules.html','window1','toolbar=no,location=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=300,height=400')"><b>Rules</b></a>.
	</td>
   </tr>
  ...
  <tr>
    <td valign="top"> 
      <form name="frm" action="<%=handler%>" method=post>
        <input type=hidden name="promo_name" value="10EasyFeature">
        <input type=hidden name="return_url" value="javascript:parent.parent.close();">
        <table border=0 cellpadding=0 cellspacing=5 width="450" align="center">
          <tr> 
            <td valign=top width="314"> 
              <table border=0 width="450" cellpadding="0" cellspacing="15">
                
                <tr> 
                  <td valign=top width="168"><b> First Name<span class="red">*</span>:</b></td>
                ...
                <tr> 
                  <td valign=top width="168"><b>Last Name<span class="red">*</span>:</b></td>
                  <td valign=top width="194"> 
                ...
                <tr> 
                  <td valign=top width="168"><b>Email Address<span class="red">*</span>:</b></td>
                  <td valign=top width="194"> 
                    <input name="email_address" size=30 maxlength=50 onChange="javascript:testEmail(this.value, 'Please enter a valid email (xxx@yyy.zzz).')">
                  </td>
                </tr>
                
                
                <tr> 
                  <td valign=top width="168"><b>Address 1:</b></td>
                  <td valign=top width="194"> 
                    <input name="address1" size=30 maxlength=30>
                  </td>
                </tr>
                
                <tr> 
                  <td valign=top width="168"><b>Address 2:</b></td>
                  <td valign=top width="194"> 
                ...
                <tr> 
                  <td valign=top width="168"><b>City<span class="red">*</span>:</b></td>
                  <td valign=top width="194"> 
                ...
                <tr> 
                  <td valign=top width="168"><b>State<span class="red">*</span>:</b></td>
                  <td valign=top width="194"> 
                ...
                <tr> 
                  <td colspan=2> 
                    <p>Please uncheck this box if you would not like
                    to be included in any future Riveted mailings.
                      <input type=checkbox name="emailme" value="yes" checked>
                    </p>
                  </td>
                </tr>
                
                <tr>
				 <td width="500" align="left"><span class="small"><span class="red">* denotes required fields</span></span></td>
				</tr>
