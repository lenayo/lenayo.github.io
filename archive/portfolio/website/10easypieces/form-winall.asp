...
<table width="500" height="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  
  <tr> 
    <td valign="top" align="center"><img src="images/form/promo-win10.jpg" width="500" height="420" border="0"></td>
  </tr>
  ...
  <tr> 
    <td width="500" align="center">
     <b>Riveted by Lee&reg;</b> gives away <b>ALL 10 of our Easy Pieces collection</b><br> 
     to one lucky winner each month. Double-check that your e-mail address<br>
     is accurate so we can notify you if you've won!<br>
  ...
  <tr>
    <td valign="top"> 
      <form name="frm" action="<%=handler%>" method=post>
        <input type=hidden name="promo_name" value="10EasyPieces">
